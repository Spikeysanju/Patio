...
class SignUpActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(www.sanju.`in`.R.layout.activity_sign_up)


        mSignUpBtn = findViewById(www.sanju.`in`.R.id.csignUpBtn)
        loginNow = findViewById(www.sanju.`in`.R.id.csigninBtn)
